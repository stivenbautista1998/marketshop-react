    ...
    return (
        <div className="wrapper-recovery">
            ...
            <main>
                ...
                <p className="general-message-link grey__message">Didn’t receive the email?</p> <Link to="/password-recovery" className="general-message-link green__message">Resend</Link>
            </main>
        </div>
    )
}
